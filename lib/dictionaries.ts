...
const ar: Dict = {
  ...
  hero: {
    ...
    lead: 'منهج هادئ مبني على الدليل العلمي والتقييم الإكلينيكي — تشخيص واضح، وخطة علاج منظمة، وتوقعات واقعية.',
  ...
  cta: {
    ...
    bookWhatsApp: 'احجز من خلال واتساب',
    call: 'اتصل بالعيادة'
  },
  reviews: {
  ...
  testimonials: {
    title: 'آراء المرضى',
    subtitle: 'مقتطفات من آراء المرضى المنشورة على المنصات العامة.'
  },
  dashboard: {
    title: 'لوحة التحكم',
    subtitle: 'منطقة إدارة مبسطة لإضافة مقالات المدونة لاحقًا. حاليًا توضّح طريقة عمل نظام المحتوى.',
    ...
    postDescriptionPh: 'ملخص يظهر في صفحة المقالات…',
    createDraft: 'إنشاء مسودة',
    notConnected: 'لوحة التحكم غير متصلة بعد. الخطوة التالية: ربط نظام CMS أو قاعدة بيانات.',
    ...
    securityNote: 'ملاحظة: يجب تأمين هذا المسار قبل استخدامه في بيئة الإنتاج.'
  },
  results: {
  ...
  contact: {
    ...
    subtitle: 'الأسرع هو إرسال رسالة عبر واتساب، ويمكنك الاتصال بالعيادة أيضًا.',
    formTitle: 'أرسل رسالة',
    formHint: 'هذه الاستمارة مؤقتة حاليًا، وأسرع وسيلة للحجز هي واتساب.',
    name: 'الاسم',
    namePh: 'اسمك',
    phone: 'الهاتف',
    phonePh: '+20…',
    message: 'الرسالة',
    messagePh: 'اكتب كيف نقدر نساعدك',
    send: 'إرسال',
    ...
    whatsappHint: 'أسرع رد يكون عبر واتساب',
    mapLabel: 'الخريطة'
  }
}
